...
import storeaui.widget.ActionBar.ActionBarView;
import storeaui.widget.ActionBar.ActionBarView.OnBackKeyItemClick;
import storeaui.widget.ActionBar.ActionBarView.OnLeftWidgetItemClick;
import storeaui.widget.ActionBar.ActionBarView.OnLeftWidgetItemClick2;
import storeaui.widget.ActionBar.ActionBarView.OnOptionMenuClick;
import storeaui.widget.ActionBar.ActionBarView.OnRightWidgetItemClick;
import storeaui.widget.ActionBar.ActionBarView.OnRightWidgetItemClick2;
...
//        ab.setCustomView(view);
    ...
    public void showBackKey(boolean show, Drawable backIcon) {
        if (mActionBarView == null)
            return;

        mActionBarView.showBackKey(show, backIcon, new OnBackKeyItemClick() {
