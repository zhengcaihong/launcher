...
import storeaui.util.CompatibilityUtil;
import storeaui.util.Config;
import storeaui.util.DensityUtil;
...
public class ActionSheet implements OnClickListener {
     ...
     * 
     * See {@link #setCommonButtons(List<String>, List<Integer>, List<Boolean>, CommonButtonListener)},
     */
     ...
     * 
     * See {@link #setSingleChoiceItems(CharSequence[], int, SingleChoiceListener)}
     */
     ...
     * 
     * See {@link #setMultiChoiceItems(CharSequence[], boolean[], MultiChoiceListener, ActionButton)}
     */
     ...
     * 
     * @see setCustomAdapterView(List<ActionListItem>, ActionSheetCustomAdapter)
     */
    ...
    public View createContentView() {
        if (!isShowPhoneStyle()) {
            ...
            if (isNeedBuild) {
                constructActionSheetForPhoneStyle();
                isNewContentView = true;
                isNeedBuild = false;}
    ...
    /**
     * set the Window type of dialog(e.g.TYPE_SYSTEM_ALERT)
     * need to call before showWithDialog2
     */
    ...
    public Dialog showWithDialog2() {
        if (mDialog == null) {
            mDialog = new ActionSheetDialog(this, mContext,
                    R.style.Theme_Ali_Dialog_ActionSheet);
            ...
            if (type != -1) {
                localLayoutParams.type = this.type;
            }
...
//        if(isShowPhoneStyle()) constructCancelButton();
    ...
    private void constructActionSheetForPhoneStyle() {
        mItemDividers.clear();
        constructContentPanel();
        ...
        mLayoutDomain = new LinearLayout(mContext);
        mLayoutDomain.setBackground(mContext.getResources().getDrawable(
                R.drawable.hw_actionsheet_background));
        mLayoutDomain.setOrientation(LinearLayout.VERTICAL);
...
//        constructCancelButton();
    ...
    private void constructContentPanel() {
        ...
        mPanel.setPadding(0, paddingOffset, 0, 0);
    }
    ...
    private void constructTitle(LinearLayout layout) {
        ...
        mTitleView.setTextSize(actionSheetTextSize/ mContext.getResources().getConfiguration().fontScale);
        ...
        LinearLayout.LayoutParams params1 = new LinearLayout.LayoutParams(
                LayoutParams.MATCH_PARENT, DensityUtil.dip2px(mContext, 1));
        View divider = new View(mContext);
        divider.setBackgroundResource(R.drawable.hw_actionsheet_divider);
    ...
    private LinearLayout constructActionButtonLayout() {
        ...
        for(int i = 0;i < actionButtonSize;i++) {
            ...
            if(actionButton.getTextView() == null) {
                ...
                actionButtonItem.setTextSize(actionSheetTextSize/ mContext.getResources().getConfiguration().fontScale);
    ...
    private void constructCancelButton() {
        ...
        mCancelButton.setTextSize(actionSheetTextSize/ mContext.getResources().getConfiguration().fontScale);
    ...
    public void setMessage(CharSequence message, ActionButton...actionButtons) {
        ...
        tv.setTextSize(actionSheetTextSize/ mContext.getResources().getConfiguration().fontScale);
    ...
    public void setMultiChoiceItems(CharSequence[] items, boolean[] checkedItems,
        ...
        List<ActionListItem> multiItems = new ArrayList<ActionSheet.ActionListItem>();
        for(int i = 0;i < items.length; i++) {
     ...
     * @param listener
     *
     * see {@link hwdroid.widget.ActionSheet$ActionSheetListener}
     * 
