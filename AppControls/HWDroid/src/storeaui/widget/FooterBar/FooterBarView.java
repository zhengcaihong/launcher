package storeaui.widget.FooterBar;
...
public class FooterBarView extends LinearLayout implements FooterBarType {
	...
	private void init(Context context) {
		...
		mDivider = (View)findViewById(R.id.hw_titleDivider);
	...
	/**
	 * Set the background of Divider View.
	 * It <strong>must</strong> be called before the {@link #updateItems()}
	 * @param drawable The background of the divider.
	 */
	@Override
	...
	public void updateItems() {
		if(mDividerDrawable != null) {
			mDivider.setBackground(mDividerDrawable);
		}
		addItemView();
	}
