package storeaui.widget.ActionBar;

import java.lang.ref.WeakReference;

import storeaui.widget.ActionBar.ActionBarOptionMenuPopup.ActionBarOptionMenuListener;
...
public class ActionBarView extends LinearLayout implements ActionBarOptionMenuListener{
    ...
    public void showBackKey(boolean show, OnBackKeyItemClick click) {
        Drawable backIcon = getResources().getDrawable(
                ActionBarView.BackKeyIcon);
        showBackKey(show, backIcon, click);
    }
    ...
    public void showBackKey(boolean show, Drawable backIcon,
        ...
        if (show) {
            ...
            if (backIcon != null) {
                Message msg = new Message();
                msg.what = UPDATE_ID_SHOW_BACKKEY;
                msg.obj = backIcon;
                mUpdateHandler.sendMessage(msg);
            }
        }
	...
	private static final class UpdateHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case UPDATE_ID_SHOW_BACKKEY:
                    Drawable backIcon=(Drawable)msg.obj;
                    showBackKeyInner(backIcon);
                    break;
        ...
        private void showBackKeyInner(Drawable backIcon) {
