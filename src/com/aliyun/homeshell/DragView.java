...
public class DragView extends View {
    ...
    public static final float SCREEN_SCALE = 1.05f;
    ...
    private final float VIEW_ALPHA = 0.9f;
    /*YUNOS END*/
    private final float VIEW_SHADOW_DEPTH = 10.0f;

    private static final int SHADOW_COLOR = LauncherApplication.getContext()
            .getResources().getColor(R.color.icon_drag_shadown_color);
    private static final int COLOR_FILTER = LauncherApplication.getContext()
            .getResources().getColor(R.color.icon_drag_color_filter);
    ...
    public DragView(Launcher launcher, Bitmap bitmap, int registrationX, int registrationY,
            int left, int top, int width, int height, final float initialScale, boolean isCellLayout) {
        super(launcher);
        ...
        //##module(component name)
        //##date:2014/03/28 ##author:jun.dongj@alibaba-inc.com##BugID:105707
        //##date:2015/06/23 ##author:zhanggong.zg ##BugID:6091020
        //re-set the icon long press effect
        final float scale = (isCellLayout ? SCREEN_SCALE : SCALE) * initialScale;
        /*YUNOS END*/
        ...
        mPaint.setShadowLayer(0, VIEW_SHADOW_DEPTH, VIEW_SHADOW_DEPTH, SHADOW_COLOR);
        mPaint.setColor(COLOR_FILTER);
        mPaint.setAlpha((int) (255 * VIEW_ALPHA));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //YUNOS BEGIN added by xiaodong.lxd : update dragview look
    ...
    public void setCrossFadeBitmap(Bitmap crossFadeBitmap) {
        if (mCrossFadeBitmap != null) {
            mCrossFadeBitmap.recycle();
        }
    ...
    void move(int touchX, int touchY) {
        ...
        if (mOnMoveListener != null) {
            mOnMoveListener.onMove(this, touchX, touchY);
        }
    }
    ...
    public interface OnMoveListener {
        void onMove(View dragView, int touchX, int touchY);
    }
}
