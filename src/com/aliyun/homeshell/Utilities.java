...
public final class Utilities {
    ...
    public enum DisableType {
        appDownload, sdcardLoading, sdcardOpt
    }
    ...
    public static Drawable createIconDrawable(Drawable icon, Context context){
    	return new FastBitmapDrawable(createIconBitmap(icon,context));
    }
    /**
    ...
    private static void initStatics(Context context) {
        ...
        // add theme icon
        sIconWidth = sIconHeight = ThemeUtils.getIconSize(context);
        if (sIconWidth <= 0) {
